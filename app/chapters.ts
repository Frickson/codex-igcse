export type Chapter = {
  n: number;
  /** Route segment relative to the site root, e.g. "chapter-4". */
  path: string;
  title: string;
  blurb: string;
};
...
// Cambridge IGCSE Physics 0625 (2026–2028) has Topics 1–6 only — there is no Topic 7.
export const CHAPTERS: Chapter[] = [
  ...
  { n: 4, path: "chapter-4", title: "Electricity & magnetism", blurb: "Magnetism, electrical quantities, circuits, electrical safety and electromagnetic effects." },
